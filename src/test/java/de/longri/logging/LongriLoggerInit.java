    ...
    static {
        ...
        try {
            ...
            if (SystemType.isWindows()) {
                LongriLoggerConfiguration.setConfigurationFile(LongriLoggerInit.class.getClassLoader().getResourceAsStream("logger/longriLoggerWin.properties"));
            } else if (SystemType.isLinux() || SystemType.getSystemType() == SystemType.UNKNOWN) {
                LongriLoggerConfiguration.setConfigurationFile(LongriLoggerInit.class.getClassLoader().getResourceAsStream("logger/longriLoggerLinux.properties"));
            } else {
