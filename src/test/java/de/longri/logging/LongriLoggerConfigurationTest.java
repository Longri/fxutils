...
class LongriLoggerConfigurationTest {
    ...
    void init() throws IOException {
        ...
        Local_FileTransferHandle local_fileTransferHandle = new Local_FileTransferHandle(file);
        local_fileTransferHandle.writeString("TestString", true);
        ...
        LongriLoggerConfiguration config = new LongriLoggerConfiguration();
        config.init(inputStream);
        ...
        for (PrintStream stream : config.outputChoice) {
        ...
        assertTrue(currentLogFile.exists());
        assertEquals("TestString", new Local_FileTransferHandle(currentLogFile).readString());
