...
/**
 * Created by Longri on 10.12.23
 */
public class VariableByteStoreTest {
    ...
    public void testBooleanObject() throws Exception {
        ...
        VariableByteStore writer = new VariableByteStore();
        obj.serialize(writer);
        obj2.deserialize(new VariableByteStore(writer.getArray()));
        System.out.println("VariableByteStore-Boolean: " + writer.getArray().length + " Bytes!");
    ...
    public void testByteObject() throws Exception {
        ...
        System.out.println("VariableByteStore-Byte: " + writer.getArray().length + " Bytes!");
    ...
    public void testShortObject() throws Exception {
        ...
        System.out.println("VariableByteStore-Short: " + writer.getArray().length + " Bytes!");
    ...
    public void testIntegerObject() throws Exception {
        ...
        System.out.println("VariableByteStore-Integer: " + writer.getArray().length + " Bytes!");
    ...
    public void testLongObject() throws Exception {
        ...
        System.out.println("VariableByteStore-Long: " + writer.getArray().length + " Bytes!");
    ...
    public void testArray() throws Exception {
        ...
        VariableByteStore reader = new VariableByteStore(byteArray);
    ...
    public void testString() throws Exception {
        ...
        System.out.println("VariableByteStore-String: " + writer.getArray().length + " Bytes!");
    ...
    public void testLocalDateTime() throws Exception {
        ...
        VariableByteStore reader = new VariableByteStore(writer.getArray());

        LocalDate storedNow = reader.readLocalDate();
        LocalDateTime storedNowTime = reader.readLocalDateTime();

        assertEquals(storedNow, now);
        assertEquals(storedNowTime, nowTime);


        writer = new VariableByteStore();
        now = null;
        nowTime = null;
        writer.write(now);
        writer.write(nowTime);

        reader = new VariableByteStore(writer.getArray());

        storedNow = reader.readLocalDate();
        storedNowTime = reader.readLocalDateTime();
