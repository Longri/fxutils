...
public interface PathFilter {
	...
	/**
	 * @param pathName {@link String} to test
	 * @return true in case the given {@link String} matches with the {@link Predicate}.
	 */
	...
	/**
	 * @param file {@link FileTransferHandle}
	 * @return true in case the given {@link FileTransferHandle} matches with the {@link Predicate}.
	 */
	default boolean matches(FileTransferHandle file) {
