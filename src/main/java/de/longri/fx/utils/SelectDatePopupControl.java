...
public class SelectDatePopupControl extends PopupControl {
    final TextField SEARCH_FIELD;

    Logger log = LoggerFactory.getLogger(SelectDatePopupControl.class);

    public SelectDatePopupControl(TextField searchField) {
    ...
    void initial() {
        this.SEARCH_FIELD.focusedProperty().addListener(new ChangeListener<Boolean>() {
            ...
            public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newFocused) {
                if (!newFocused) {
                    ...
                    SelectDatePopupControl.this.hide();
                } else {
                    show(SelectDatePopupControl.this.SEARCH_FIELD);
                }
            }
        });
        this.SEARCH_FIELD.textProperty().addListener(new ChangeListener<String>() {
            ...
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                if (!SelectDatePopupControl.this.isShowing()) {
                    show(SelectDatePopupControl.this.SEARCH_FIELD);
                }
            }
        });
    ...
    protected Skin<?> createDefaultSkin() {
        return new SelectDatePopupControlSkin(this);
    }
