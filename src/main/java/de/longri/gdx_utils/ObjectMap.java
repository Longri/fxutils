...
import static de.longri.gdx_utils.ObjectSet.tableSize;
...
public class ObjectMap<K, V> implements Iterable<ObjectMap.Entry<K, V>> {
     ...
     * <p>
     * If {@link Array#allocateIterators} is false, the same iterator instance is returned each time this method is called.
    ...
    static public class Values<V> extends MapIterator<Object, V, V> {
        ...
        public Array<V> toArray() {
            return toArray(new Array(map.size));
        }
