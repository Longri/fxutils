 ...
 ******************************************************************************/
package de.longri.gdx_utils.files;
...
import de.longri.gdx_utils.StreamUtils;
import de.longri.gdx_utils.files.Files.FileType;
...
public class FileHandle {
    ...
    public File file () {
        if (type == FileType.External) return new File(UTILS.files.getExternalStoragePath(), file.getPath());
        return file;
    }
