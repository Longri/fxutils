/*******************************************************************************
 * Copyright 2011 LibGdx https://github.com/libgdx/libgdx/blob/master/gdx/src/com/badlogic/gdx/utils/IntArray.java
 *
...
public class IntArray implements Iterable<Integer> {
    ...
    public Iterator<Integer> iterator() {
        ArrayIntIterator arrayIterator = new ArrayIntIterator(this, true);
        arrayIterator.index = 0;
        return arrayIterator;
    }

    static public class ArrayIntIterator implements Iterator<Integer>, Iterable<Integer>, ListIterator<Integer> {
        private final IntArray array;
        private final boolean allowRemove;
        int index;
        boolean valid = true;

        public ArrayIntIterator(IntArray array) {
            this(array, true);
        }

        public ArrayIntIterator(IntArray array, boolean allowRemove) {
            this.array = array;
